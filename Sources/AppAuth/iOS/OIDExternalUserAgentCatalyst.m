...
-(void)createLeftBarButtonItem
{
    if (self.navigationItem.leftBarButtonItem == nil)
    {
        UIImage *xIcon = [[UIImage systemImageNamed:@"xmark"]
                          imageWithTintColor:[UIColor secondaryLabelColor] renderingMode:UIImageRenderingModeAlwaysOriginal];
...
- (BOOL)presentExternalUserAgentRequest:(id<OIDExternalUserAgentRequest>)request
  ...
  if (!openedUserAgent && _presentingViewController) {
      ...
      safariVC.preferredContentSize = CGSizeMake(768, height * 0.8);
